            ...
            ScrollView(.vertical, showsIndicators: false) {
                VStack(spacing: 20) {
                    ...
                    GroupBox(
                        ...
                        Text("If you wish, you can restart the application by toggling the switch in this box. That way it satarts the onboarding processs and you will see the welcome screen again.")
                            .padding(.vertical, 8)
                            .frame(minHeight: 60)
                            .layoutPriority(1)
                            .font(.footnote)
                    ...
                    GroupBox(
                        ...
                        SettingsRowView(name: "Developer", content: "Victor Ughonu")
